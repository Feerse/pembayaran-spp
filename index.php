...
<head>
    ...
    <link rel="stylesheet" href="./src/css/style.css?ver=1">
</head>

<body class="bg-gray-200 text-gray-700">
    <div class="flex justify-center items-center h-[100vh]">
        <div class="w-full max-w-sm">
            <form action="proses-login-siswa.php" method="post" class="bg-white shadow-md rounded-md px-8 pt-6 pb-8 mb-4">
